...
func TestSurfaceZArrFromXYPairs(t *testing.T) {
	...
	xv_surf := []float64{461225.5035311932, 461279.6440995966, 461333.784668, 461387.9252364034, 461442.06580480695, 461496.20637321053, 461550.34694161406, 461604.4875100175, 461658.628078421,
	...
	yv_surf := []float64{5932172.006023725, 5932079.265218862, 5931986.524414, 5931893.783609138, 5931801.042804276, 5931708.301999416, 5931615.561194555, 5931522.820389693, 5931430.07958483, 5931337.338779969,
	...
	tests := []struct {
		...
		},
		{
			...
			algo:    NearestNeighbor,
			wantZv:  []float32{UndefMap, 4.0, 8.0},
			wantErr: false,
		},
	}
