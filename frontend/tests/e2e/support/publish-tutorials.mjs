...
//
// Invoked automatically by the recording run's global teardown (tests/e2e/setup/globalTeardown.ts).
// Can also be run manually after a finished RECORD=1 run:
...
function resolveStepsFile(videoFile) {
...
async function main() {
    ...
    for (const dir of manifestDirs) {
        const manifest = JSON.parse(readFileSync(join(dir, MANIFEST_NAME), "utf-8"));
