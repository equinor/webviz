...
import { findClosestSeriesEntryByValue } from "@modules/_shared/eCharts/interaction/hitTesting";

describe("findClosestSeriesEntryByValue", () => {
    it("returns the nearest member for the hovered category index", () => {
        ...
        const target = findClosestSeriesEntryByValue(series, 1, 18.4);
    ...
    it("skips non-finite values and returns null when no valid candidate exists", () => {
        ...
        const target = findClosestSeriesEntryByValue(series, 1, 19);
