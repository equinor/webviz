...
import { findClosestRealizationSeries } from "@modules/_shared/eCharts/hooks/useClosestRealizationTooltip";

describe("findClosestRealizationSeries", () => {
    it("returns the nearest realization for the hovered category index", () => {
        const target = findClosestRealizationSeries(
            [
