...
export function Settings({ settingsContext }: ModuleSettingsProps<Interfaces>) {
    ...
    function handleThresholdChanged(value: number | null) {
        ...
        <Collapsible.ScrollArea>
            <SettingWrapper.Group>
                <SettingWrapper.Section title="Plot settings" defaultOpen>
                    <SettingWrapper label="Matrix type">
                        <RadioCompositions.GroupWithLabels
                            options={plotTypesOptions}
                            value={plotType as string}
                            onValueChange={handlePlotTypeChanged}
                        />
                    </SettingWrapper>
                    <SettingWrapper>
                ...
                <SettingWrapper.Section title="Correlation settings" defaultOpen>
