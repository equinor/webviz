...
type SettingsWithTypes = MakeSettingTypesMap<RealizationSeismicDepthSliceSettings>;
        ...
        >
{
    ...
    fetchData({
        ...
        RealizationSeismicDepthSliceSettings,
        RealizationSeismicDepthSliceData
    >): Promise<RealizationSeismicDepthSliceData> {
    ...
    defineDependencies({
        ...
        storedDataUpdater,
        queryClient,
    }: DefineDependenciesArgs<RealizationSeismicDepthSliceSettings, RealizationSeismicDepthSliceStoredData>): void {
