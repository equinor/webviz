...
export class GridLayerJRangeSetting implements Setting<ValueType> {
    ...
    makeComponent(): (props: SettingComponentProps<ValueType>) => React.ReactNode {
        return function JRangeSlider(props: SettingComponentProps<ValueType>) {
            ...
            return (
                <Slider
                    ...
                    value={props.value ?? [0, props.availableValues[1] ?? 1]}
                    debounceTimeMs={500}
...
SettingRegistry.registerSetting(GridLayerJRangeSetting);
