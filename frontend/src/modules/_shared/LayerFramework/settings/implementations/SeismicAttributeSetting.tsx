...
export class SeismicAttributeSetting implements Setting<ValueType> {
    ...
    getType(): SettingType {
        return SettingType.SEISMIC_ATTRIBUTE;
    }
...
SettingRegistry.registerSetting(SeismicAttributeSetting);
