...
// for the SettingRegistry module and registering the settings after the module is loaded.
try {
    await import("./SettingRegistry").then(({ SettingRegistry }) => {
        ...
        SettingRegistry.registerSetting(
            ...
            "SMDA Wellbore Headers",
            DrilledWellboresSetting,
        );
