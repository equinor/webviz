...
export function PersistableAtomWarningWrapper<T>(props: PersistableAtomWarningWrapperProps<T>) {
    ...
    const warningMessage = usePersistableAtomWarningMessage(props.atom);
...
export function usePersistableAtomWarningMessage(atom: PersistableFixableAtom<any>): string | null {
