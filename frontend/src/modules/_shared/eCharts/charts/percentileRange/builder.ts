...
export type PercentileRangeChartOptions = BaseChartOptions & PercentileRangeDisplayOptions & {
    xAxisLabel?: string;
    yAxisLabel?: string;
};
...
export function buildPercentileRangeChart(
    ...
    const buildSubplot = function buildPercentileRangeSubplotForAxis(
        ...
        return buildPercentileRangeSubplot(group, axisIndex, options, xAxisLabel, yAxisLabel);
    };
