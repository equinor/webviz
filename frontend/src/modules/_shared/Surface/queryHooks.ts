...
import { peekSurfAddrType } from "./surfaceAddress";
import { FullSurfAddr } from "./surfaceAddress";
...
export function useSurfaceDataQuery(
    ...
    if (surfAddrStr) {
        const surfAddrType = peekSurfAddrType(surfAddrStr);
...
export function useSurfaceDataQueryByAddress(surfAddr: FullSurfAddr | null, format: "float", resampleTo: SurfaceDef_api | null, allowEnable: boolean): UseQueryResult<SurfaceDataFloat_trans>; // prettier-ignore
export function useSurfaceDataQueryByAddress(surfAddr: FullSurfAddr | null, format: "png", resampleTo: SurfaceDef_api | null, allowEnable: boolean): UseQueryResult<SurfaceDataPng_api>; // prettier-ignore
export function useSurfaceDataQueryByAddress(
    surfAddr: FullSurfAddr | null,
    format: "float" | "png",
    resampleTo: SurfaceDef_api | null,
    allowEnable: boolean
): UseQueryResult<SurfaceDataFloat_trans | SurfaceDataPng_api> {
