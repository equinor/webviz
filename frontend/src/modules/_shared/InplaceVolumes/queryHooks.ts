...
/**
 * Same as `makeAggregatedStatisticalTableDataQueryOptions`, but for an explicit list of sources rather
 ...
 */
export function makeAggregatedStatisticalTableDataQueryOptionsFromSources(
