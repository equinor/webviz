...
import { Data, RealizationSurfaceSettings } from "../customLayerImplementations/RealizationSurfaceLayer";
...
export function makeRealizationSurfaceLayer({
    ...
    getData,
    getSetting,
}: VisualizationFunctionArgs<RealizationSurfaceSettings, Data>): ColormapLayer | Grid3DLayer | null {
    const data = getData();
