...
//     const [selectedStatOrReal, setSelectedStatOrReal] = React.useState<StatisticsOrRealization>(
//         StatisticsOrRealization.Realization
//     );
//     const [selectedRealization, setSelectedRealization] = React.useState<number>(0);
//     const [selectedStatOption, setSelectedStatOption] = React.useState<StatisticFunction_api>(
...
//     const setDatedTrees = settingsContext.useSetStoreValue("datedTrees");
...
//     // }
//     const groupTreeQuery = useRealizationGroupTreeQuery(
//         selectedEnsembleIdent?.getCaseUuid(),
//         selectedEnsembleIdent?.getEnsembleName(),
//         selectedRealization,
//         selectedResampleFrequency
//     );
...
//         groupTreeQuery.data.dated_trees[0].tree.children;
//     }
//     const uniqueDates = [...new Set(dates)];
//     const [selectedDate] = useValidState<string | null>({
//         initialState: null,
//         validStates: uniqueDates,
//     });

//     const datedTrees = groupTreeQuery.data?.dated_trees ?? [];
//     setDatedTrees(datedTrees);
...
//         setResamplingFrequency(newFreqStr as Frequency_api);
//     }
...
//                     <Dropdown
//                         options={validEdgeKeys.map((item) => {
...
//                     <Dropdown
//                         options={validNodeKeys.map((item) => {
//                             return { label: item, value: item };
//                         })}
