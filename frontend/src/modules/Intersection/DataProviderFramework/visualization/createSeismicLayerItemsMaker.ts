                ...
                new SeismicLayer(
                    `${id}-seismic-layer`,
                    {
                        ...
                        data: {
                            ...
                            nearestRealTraceFenceTracesArray: fenceData.nearestRealTraceFenceTracesFloat32Arr,
                            nearestRealTraceInline: fenceData.nearest_real_trace_inline,
                            nearestRealTraceCrossline: fenceData.nearest_real_trace_crossline,
