...
import { EnsembleSensitivity, EnsembleScalarResponse } from "@api";
...
): UseQueryResult<EnsembleSensitivity[]> {
    return useQuery({
        queryKey: [
            "sensitivityCorrelationForInplaceVolumes",
            caseUuid,
            ensembleName,
        ...
        queryFn: () =>
            apiService.parameters.getSensitivities(
                caseUuid ?? "",
                ensembleName ?? "",
            ),
