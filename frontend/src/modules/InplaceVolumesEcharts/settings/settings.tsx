...
import { PlotType, plotTypeToStringMapping, BarSortBy, type InplaceVolumesPlotOptions } from "../typesAndEnums";
    ...
    const plotSettings = (
        <div className="flex flex-col gap-2">
            ...
            <CollapsibleGroup title="Plot settings" expanded contentClassName="flex flex-col gap-2">
                ...
                selectedPlotType === PlotType.PERCENTILE_RANGE ||
                selectedPlotType === PlotType.DENSITY ? (
                    <Checkbox
                ...
                {(selectedPlotType === PlotType.HISTOGRAM || selectedPlotType === PlotType.DENSITY) && (
                    <Checkbox
