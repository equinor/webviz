...
import { authorizedCallbackRoute, createSession, createSnapshot, deleteSession, deleteSnapshot, deleteSnapshotAccessLog, deprecatedGetStratigraphicUnits, getAlive, getAliveProtected, getAssetNames, getCases, getCrosslineSlice, getDeltaEnsembleRealizationsVectorData, getDeltaEnsembleStatisticalVectorData, getDeltaEnsembleVectorList, getDeltaSurfaceData, getDepthSlice, getDrilledWellboreHeaders, getEnsembleDetails, getFieldPerforations, getFieldScreens, getGridModelsInfo, getGridParameter, getGridSurface, getHistoricalVectorData, getInjectionData, getInlineSlice, getLogCurveData, getLoggedInUser, getMisfitSurfaceData, getObservations, getObservedSurfacesMetadata, getParametersAndSensitivities, getPolygonsData, getPolygonsDirectory, getProductionData, getRealizationData, getRealizationFlowNetwork, getRealizationSurfacesMetadata, getRealizationsVectorData, getRealizationVectorAtTimestamp, getSeismicCubeMetaList, getSeismicSlices, getSession, getSessionMetadata, getSessionsMetadata, getSnapshot, getSnapshotAccessLogs, getSnapshotsMetadata, getStatisticalSurfaceDataHybrid, getStatisticalVectorData, getStatisticalVectorDataPerSensitivity, getStratigraphicUnitsForStratColumn, getSurfaceData, getTableData, getTableDefinition, getTableDefinitions, getTimestampsList, getUserInfo, getUserPhoto, getVectorList, getVfpTable, getVfpTableNames, getWellboreCasings, getWellboreCompletions, getWellboreLogCurveHeaders, getWellborePerforations, getWellborePickIdentifiers, getWellborePicksForPickIdentifier, getWellborePicksInStratColumn, getWellboreStratigraphicColumns, getWellCompletionsData, getWellTrajectories, loginRoute, type Options, postGetAggregatedPerRealizationTableData, postGetAggregatedStatisticalTableData, postGetPolylineIntersection, postGetSampleSurfaceInPoints, postGetSeismicFence, postGetSurfaceIntersection, postLogout, postRefreshFingerprintsForEnsembles, root, updateSession } from '../sdk.gen';
import type { AuthorizedCallbackRouteData_api, CreateSessionData_api, CreateSessionError_api, CreateSessionResponse_api, CreateSnapshotData_api, CreateSnapshotError_api, CreateSnapshotResponse_api, DeleteSessionData_api, DeleteSessionError_api, DeleteSnapshotAccessLogData_api, DeleteSnapshotAccessLogError_api, DeleteSnapshotData_api, DeleteSnapshotError_api, DeprecatedGetStratigraphicUnitsData_api, GetAliveData_api, GetAliveProtectedData_api, GetAssetNamesData_api, GetCasesData_api, GetCrosslineSliceData_api, GetDeltaEnsembleRealizationsVectorDataData_api, GetDeltaEnsembleStatisticalVectorDataData_api, GetDeltaEnsembleVectorListData_api, GetDeltaSurfaceDataData_api, GetDepthSliceData_api, GetDrilledWellboreHeadersData_api, GetEnsembleDetailsData_api, GetFieldPerforationsData_api, GetFieldScreensData_api, GetGridModelsInfoData_api, GetGridParameterData_api, GetGridSurfaceData_api, GetHistoricalVectorDataData_api, GetInjectionDataData_api, GetInlineSliceData_api, GetLogCurveDataData_api, GetLoggedInUserData_api, GetMisfitSurfaceDataData_api, GetObservationsData_api, GetObservedSurfacesMetadataData_api, GetParametersAndSensitivitiesData_api, GetPolygonsDataData_api, GetPolygonsDirectoryData_api, GetProductionDataData_api, GetRealizationDataData_api, GetRealizationFlowNetworkData_api, GetRealizationSurfacesMetadataData_api, GetRealizationsVectorDataData_api, GetRealizationVectorAtTimestampData_api, GetSeismicCubeMetaListData_api, GetSeismicSlicesData_api, GetSessionData_api, GetSessionMetadataData_api, GetSessionsMetadataData_api, GetSessionsMetadataError_api, GetSessionsMetadataResponse_api, GetSnapshotAccessLogsData_api, GetSnapshotAccessLogsError_api, GetSnapshotAccessLogsResponse_api, GetSnapshotData_api, GetSnapshotsMetadataData_api, GetSnapshotsMetadataError_api, GetSnapshotsMetadataResponse_api, GetStatisticalSurfaceDataHybridData_api, GetStatisticalVectorDataData_api, GetStatisticalVectorDataPerSensitivityData_api, GetStratigraphicUnitsForStratColumnData_api, GetSurfaceDataData_api, GetTableDataData_api, GetTableDefinitionData_api, GetTableDefinitionsData_api, GetTimestampsListData_api, GetUserInfoData_api, GetUserPhotoData_api, GetVectorListData_api, GetVfpTableData_api, GetVfpTableNamesData_api, GetWellboreCasingsData_api, GetWellboreCompletionsData_api, GetWellboreLogCurveHeadersData_api, GetWellborePerforationsData_api, GetWellborePickIdentifiersData_api, GetWellborePicksForPickIdentifierData_api, GetWellborePicksInStratColumnData_api, GetWellboreStratigraphicColumnsData_api, GetWellCompletionsDataData_api, GetWellTrajectoriesData_api, LoginRouteData_api, PostGetAggregatedPerRealizationTableDataData_api, PostGetAggregatedPerRealizationTableDataError_api, PostGetAggregatedPerRealizationTableDataResponse_api, PostGetAggregatedStatisticalTableDataData_api, PostGetAggregatedStatisticalTableDataError_api, PostGetAggregatedStatisticalTableDataResponse_api, PostGetPolylineIntersectionData_api, PostGetPolylineIntersectionError_api, PostGetPolylineIntersectionResponse_api, PostGetSampleSurfaceInPointsData_api, PostGetSampleSurfaceInPointsError_api, PostGetSampleSurfaceInPointsResponse_api, PostGetSeismicFenceData_api, PostGetSeismicFenceError_api, PostGetSeismicFenceResponse_api, PostGetSurfaceIntersectionData_api, PostGetSurfaceIntersectionError_api, PostGetSurfaceIntersectionResponse_api, PostLogoutData_api, PostLogoutResponse_api, PostRefreshFingerprintsForEnsemblesData_api, PostRefreshFingerprintsForEnsemblesError_api, PostRefreshFingerprintsForEnsemblesResponse_api, RootData_api, UpdateSessionData_api, UpdateSessionError_api, UpdateSessionResponse_api } from '../types.gen';
...
export const getAssetNamesQueryKey = (options?: Options<GetAssetNamesData_api>) => createQueryKey('getAssetNames', options);
 ...
 */
export const postRefreshFingerprintsForEnsemblesOptions = (options: Options<PostRefreshFingerprintsForEnsemblesData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * delta_ensemble = comparison_ensemble - reference_ensemble
 */
export const getDeltaEnsembleRealizationsVectorDataOptions = (options: Options<GetDeltaEnsembleRealizationsVectorDataData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const getTimestampsListQueryKey = (options: Options<GetTimestampsListData_api>) => createQueryKey('getTimestampsList', options);
 ...
 * delta_ensemble = comparison_ensemble - reference_ensemble
 */
export const getDeltaEnsembleStatisticalVectorDataOptions = (options: Options<GetDeltaEnsembleStatisticalVectorDataData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const getRealizationVectorAtTimestampQueryKey = (options: Options<GetRealizationVectorAtTimestampData_api>) => createQueryKey('getRealizationVectorAtTimestamp', options);
...
export const getTableDefinitionsQueryKey = (options: Options<GetTableDefinitionsData_api>) => createQueryKey('getTableDefinitions', options);
...
export const postGetAggregatedPerRealizationTableDataQueryKey = (options: Options<PostGetAggregatedPerRealizationTableDataData_api>) => createQueryKey('postGetAggregatedPerRealizationTableData', options);
 ...
 */
export const postGetAggregatedPerRealizationTableDataOptions = (options: Options<PostGetAggregatedPerRealizationTableDataData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * As the endpoint is post, the indices with values object is kept for convenience.
 */
export const postGetAggregatedPerRealizationTableDataMutation = (options?: Partial<Options<PostGetAggregatedPerRealizationTableDataData_api>>): UseMutationOptions<PostGetAggregatedPerRealizationTableDataResponse_api, AxiosError<PostGetAggregatedPerRealizationTableDataError_api>, Options<PostGetAggregatedPerRealizationTableDataData_api>> => {
    const mutationOptions: UseMutationOptions<PostGetAggregatedPerRealizationTableDataResponse_api, AxiosError<PostGetAggregatedPerRealizationTableDataError_api>, Options<PostGetAggregatedPerRealizationTableDataData_api>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postGetAggregatedPerRealizationTableData({
                ...options,
                ...fnOptions,
...
export const postGetAggregatedStatisticalTableDataQueryKey = (options: Options<PostGetAggregatedStatisticalTableDataData_api>) => createQueryKey('postGetAggregatedStatisticalTableData', options);
 ...
 * As the endpoint is post, the indices with values object is kept for convenience.
 */
export const postGetAggregatedStatisticalTableDataOptions = (options: Options<PostGetAggregatedStatisticalTableDataData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * As the endpoint is post, the indices with values object is kept for convenience.
 */
export const postGetAggregatedStatisticalTableDataMutation = (options?: Partial<Options<PostGetAggregatedStatisticalTableDataData_api>>): UseMutationOptions<PostGetAggregatedStatisticalTableDataResponse_api, AxiosError<PostGetAggregatedStatisticalTableDataError_api>, Options<PostGetAggregatedStatisticalTableDataData_api>> => {
    const mutationOptions: UseMutationOptions<PostGetAggregatedStatisticalTableDataResponse_api, AxiosError<PostGetAggregatedStatisticalTableDataError_api>, Options<PostGetAggregatedStatisticalTableDataData_api>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postGetAggregatedStatisticalTableData({
                ...options,
                ...fnOptions,
...
export const deprecatedGetStratigraphicUnitsQueryKey = (options: Options<DeprecatedGetStratigraphicUnitsData_api>) => createQueryKey('deprecatedGetStratigraphicUnits', options);
...
export const getStratigraphicUnitsForStratColumnQueryKey = (options: Options<GetStratigraphicUnitsForStratColumnData_api>) => createQueryKey('getStratigraphicUnitsForStratColumn', options);

/**
 * Get Stratigraphic Units For Strat Column
 */
export const getStratigraphicUnitsForStratColumnOptions = (options: Options<GetStratigraphicUnitsForStratColumnData_api>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const getInlineSliceQueryKey = (options: Options<GetInlineSliceData_api>) => createQueryKey('getInlineSlice', options);
...
export const getCrosslineSliceQueryKey = (options: Options<GetCrosslineSliceData_api>) => createQueryKey('getCrosslineSlice', options);
...
export const getDepthSliceQueryKey = (options: Options<GetDepthSliceData_api>) => createQueryKey('getDepthSlice', options);
...
export const getObservationsQueryKey = (options: Options<GetObservationsData_api>) => createQueryKey('getObservations', options);
...
export const getTableDefinitionQueryKey = (options: Options<GetTableDefinitionData_api>) => createQueryKey('getTableDefinition', options);
...
export const getRealizationDataQueryKey = (options: Options<GetRealizationDataData_api>) => createQueryKey('getRealizationData', options);
...
export const getSessionsMetadataInfiniteOptions = (options?: Options<GetSessionsMetadataData_api>) => {
    return infiniteQueryOptions<GetSessionsMetadataResponse_api, AxiosError<GetSessionsMetadataError_api>, InfiniteData<GetSessionsMetadataResponse_api>, QueryKey<Options<GetSessionsMetadataData_api>>, string | null | Pick<QueryKey<Options<GetSessionsMetadataData_api>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
...
export const getSnapshotAccessLogsInfiniteOptions = (options?: Options<GetSnapshotAccessLogsData_api>) => {
    return infiniteQueryOptions<GetSnapshotAccessLogsResponse_api, AxiosError<GetSnapshotAccessLogsError_api>, InfiniteData<GetSnapshotAccessLogsResponse_api>, QueryKey<Options<GetSnapshotAccessLogsData_api>>, string | null | Pick<QueryKey<Options<GetSnapshotAccessLogsData_api>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const getSnapshotsMetadataInfiniteOptions = (options?: Options<GetSnapshotsMetadataData_api>) => {
    return infiniteQueryOptions<GetSnapshotsMetadataResponse_api, AxiosError<GetSnapshotsMetadataError_api>, InfiniteData<GetSnapshotsMetadataResponse_api>, QueryKey<Options<GetSnapshotsMetadataData_api>>, string | null | Pick<QueryKey<Options<GetSnapshotsMetadataData_api>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
