...
export type GetSurfaceDataData_api = {
    ...
    query: {
         ...
         * Surf Addr Str
         *
         * Surface address string, supported address types are *REAL*, *OBS*, *STAT*, *SR_REAL* and *SR_STAT*
         */
...
export type GetStatisticalSurfaceDataHybridData_api = {
    ...
    query: {
         ...
         * Surf Addr Str
         *
         * Surface address string, supported address types are *STAT* and *SR_STAT*
         */
        surf_addr_str: string;
        /**
         * Data Format
...
export type GetMisfitSurfaceDataData_api = {
    ...
    query: {
         ...
         * Sim Surf Addr Str
         *
         * Address of simulated surface, supported types are *REAL* and *SR_REAL*
         */
