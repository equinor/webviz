...
import { FlowNetworkService } from './services/FlowNetworkService';
...
export class ApiService {
    ...
    public readonly flowNetwork: FlowNetworkService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = AxiosHttpRequest) {
        ...
        this.flowNetwork = new FlowNetworkService(this.request);
