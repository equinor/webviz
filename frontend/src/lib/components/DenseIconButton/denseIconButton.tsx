...
const COLOR_SCHEMES: Record<DenseIconButtonColorScheme, string> = {
    [DenseIconButtonColorScheme.DEFAULT]:
        "text-gray-600 hover:text-gray-900 hover:bg-blue-300 focus:outline focus:outline-1 focus:outline-blue-600",
    [DenseIconButtonColorScheme.WARNING]:
        "text-gray-600 hover:text-gray-900 hover:bg-yellow-300 focus:outline focus:outline-1 focus:outline-yellow-600",
    [DenseIconButtonColorScheme.SUCCESS]:
        "text-gray-600 hover:text-gray-900 hover:bg-green-300 focus:outline focus:outline-1 focus:outline-green-600",
    [DenseIconButtonColorScheme.DANGER]:
        "text-gray-600 hover:text-gray-900 hover:bg-red-300 focus:outline focus:outline-1 focus:outline-red-600",
};
