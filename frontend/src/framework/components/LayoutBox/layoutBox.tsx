...
export class LayoutBox {
    ...
    findBoxContainingPoint(point: Vector2D, realSize: Size2D): LayoutBox | null {
    ...
    findEdgeContainingPoint(point: Vector2D, realSize: Size2D, draggedModuleInstanceId: string): LayoutBoxEdge | null {
