        ...
        <div className="relative h-full w-full">
            ...
            {contextLost && (
                <>
                    ...
                    <div className="bg-surface z-elevated border-neutral-subtle text-body-sm p-xs gap-xs absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded border text-center">
