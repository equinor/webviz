...
export class ModuleNotFoundPlaceholder extends Module<Record<string, never>, never, never> {
    ...
    makeInstance(instanceNumber: number): ModuleInstance<Record<string, never>, never, never> {
