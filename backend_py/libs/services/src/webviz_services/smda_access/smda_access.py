...
class SmdaAccess:
    ...
    async def get_planned_wellbore_headers_async(self, field_identifier: str) -> List[WellboreHeader]:
        ...
        Planned wellbores are fetched from the wellbore-plan-survey-headers endpoint.
        """
        projection = [
            "wellbore_uuid",
            "unique_wellbore_identifier",
        ...
        for survey_header in planned_survey_header_results:
            survey_header["wellbore_purpose"] = survey_header.get("wellbore_purpose")
            survey_header["wellbore_status"] = survey_header.get("wellbore_status")
            survey_header["kickoff_depth_md"] = survey_header.get("kickoff_depth_md")
            survey_header["kickoff_depth_tvd"] = survey_header.get("kickoff_depth_tvd")
            survey_header["parent_wellbore"] = survey_header.get("parent_wellbore")
