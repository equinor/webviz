...
async def get_stratigraphic_column_identifier_async(sumo_client: SumoClient, case_id: str) -> str:
...
async def get_field_identifiers_async(sumo_client: SumoClient, case_id: str) -> List[str]:
