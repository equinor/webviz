...
async def get_user_photo(
    ...
    if authenticated_user.has_graph_access_token():
        ...
        try:
            ...
            LOGGER.error("Error while fetching user avatar and info from Microsoft Graph API (HTTP error):\n", exc)
        except httpx.InvalidURL as exc:
            LOGGER.error("Error while fetching user avatar and info from Microsoft Graph API (Invalid URL):\n", exc)
